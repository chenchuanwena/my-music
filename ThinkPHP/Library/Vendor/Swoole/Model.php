...
class Model
{
	...
	public function insertOrReplace($msg){
		$sql="insert into `webim_message_status` set userid={$msg['to_userid']},not_read_number=1,from_userid={$msg['from_userid']} on duplicate key update not_read_number=not_read_number+1";
		$this->db->query($sql);
	}
    /**
     * 批量插入数据
