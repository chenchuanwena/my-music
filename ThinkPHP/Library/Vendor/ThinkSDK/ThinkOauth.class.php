...
abstract class ThinkOauth{
    ...
    private function config(){
		...
		//$url = 'http://'.$_SERVER['HTTP_HOST'].'/index.php?m=Oauth&a=callback&type=';
		$url = 'http://'.$_SERVER['HTTP_HOST'].'/index.php?m=home&c=Oauth&a=callback&type=';
		$this->Callback = U('/oauth/callback',array( 'type' =>strtolower($this->Type)),true,true);
		/*$config = C("THINK_SDK_{$this->Type}");
